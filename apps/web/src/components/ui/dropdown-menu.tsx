...
>(({ className, ...props }, ref) => (
	<DropdownMenuPrimitive.SubContent
		ref={ref}
		className={cn(
			"bg-popover text-popover-foreground z-70 min-w-32 overflow-hidden rounded-2xl border p-2 shadow-lg",
			className,
		)}
		{...props}
	/>
...
>(({ className, sideOffset = 4, ...props }, ref) => (
	<DropdownMenuPrimitive.Portal>
		<DropdownMenuPrimitive.Content
			...
			className={cn(
				"bg-popover text-popover-foreground z-70 min-w-32 overflow-hidden rounded-lg border p-2 shadow-lg",
				className,
			)}
			{...props}
		/>
